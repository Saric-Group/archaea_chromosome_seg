...
fname='data.ylz_patchy_hc_NOwet_NOcompact'
...
poly_mass=float(lines[14][1])
mem_mass=float(lines[15][1])
patch_mass=float(lines[16][1])
...
with open('%s/%s_rotate_xaxis_lda_norm'%(path,fname),"w") as fout:
	fout.write("LAMMPS data file\n\n%d atoms\n3 atom types\n%d ellipsoids\n%d bonds\n1 bond types\n\n0.0 %f xlo xhi\n0.0 %f ylo yhi\n0.0 %f zlo zhi\n\nMasses\n\n1 %f\n2 %f\n3 %f\n\nAtoms\n\n"%(natoms,len(ellipsoids),nbonds,box_x,box_y,box_z,poly_mass,mem_mass,patch_mass))
